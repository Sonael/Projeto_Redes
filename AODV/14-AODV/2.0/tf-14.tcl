...
$nsim attach-agent $n(6) $udp1
$nsim attach-agent $n(5) $sink1
...
$nsim attach-agent $n(10) $udp2
$nsim attach-agent $n(0) $sink2
...
$nsim attach-agent $n(4) $udp3
$nsim attach-agent $n(12) $sink3
...
$nsim attach-agent $n(1) $udp4
$nsim attach-agent $n(13) $sink4
...
$nsim attach-agent $n(2) $udp5
$nsim attach-agent $n(3) $sink5
...
$nsim attach-agent $n(9) $udp6
$nsim attach-agent $n(8) $sink6
