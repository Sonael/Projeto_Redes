...
$nsim attach-agent $n(38) $udp0
$nsim attach-agent $n(4) $sink0
...
$nsim attach-agent $n(22) $udp1
$nsim attach-agent $n(8) $sink1
...
$nsim attach-agent $n(28) $udp2
$nsim attach-agent $n(49) $sink2
...
$nsim attach-agent $n(30) $udp3
$nsim attach-agent $n(25) $sink3
...
$nsim attach-agent $n(26) $udp4
$nsim attach-agent $n(43) $sink4
...
$nsim attach-agent $n(9) $udp5
$nsim attach-agent $n(14) $sink5
...
$nsim attach-agent $n(32) $udp6
$nsim attach-agent $n(31) $sink6
...
$nsim attach-agent $n(19) $udp7
$nsim attach-agent $n(1) $sink7
...
$nsim attach-agent $n(29) $udp8
$nsim attach-agent $n(40) $sink8
...
$nsim attach-agent $n(5) $udp9
$nsim attach-agent $n(21) $sink9
...
$nsim attach-agent $n(18) $udp10
$nsim attach-agent $n(2) $sink10
...
$nsim attach-agent $n(39) $udp11
$nsim attach-agent $n(0) $sink11
...
$nsim attach-agent $n(44) $udp12
$nsim attach-agent $n(3) $sink12
...
$nsim attach-agent $n(11) $udp13
$nsim attach-agent $n(15) $sink13
...
$nsim attach-agent $n(12) $udp14
$nsim attach-agent $n(23) $sink14
...
$nsim attach-agent $n(37) $udp15
$nsim attach-agent $n(10) $sink15
...
$nsim attach-agent $n(48) $udp16
$nsim attach-agent $n(34) $sink16
...
$nsim attach-agent $n(20) $udp17
$nsim attach-agent $n(24) $sink17
...
$nsim attach-agent $n(36) $udp18
$nsim attach-agent $n(42) $sink18
...
$nsim attach-agent $n(41) $udp19
$nsim attach-agent $n(46) $sink19
...
$nsim attach-agent $n(17) $udp20
$nsim attach-agent $n(13) $sink20
...
$nsim attach-agent $n(16) $udp21
$nsim attach-agent $n(27) $sink21
...
$nsim attach-agent $n(33) $udp22
$nsim attach-agent $n(47) $sink22
...
$nsim attach-agent $n(7) $udp23
$nsim attach-agent $n(6) $sink23
...
$nsim attach-agent $n(45) $udp24
$nsim attach-agent $n(35) $sink24
