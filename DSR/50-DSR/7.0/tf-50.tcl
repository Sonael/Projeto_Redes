...
$nsim attach-agent $n(18) $udp0
$nsim attach-agent $n(22) $sink0
...
$nsim attach-agent $n(9) $udp1
$nsim attach-agent $n(41) $sink1
...
$nsim attach-agent $n(29) $udp2
$nsim attach-agent $n(43) $sink2
...
$nsim attach-agent $n(13) $udp3
$nsim attach-agent $n(1) $sink3
...
$nsim attach-agent $n(6) $udp4
$nsim attach-agent $n(4) $sink4
...
$nsim attach-agent $n(23) $udp5
$nsim attach-agent $n(10) $sink5
...
$nsim attach-agent $n(37) $udp6
$nsim attach-agent $n(0) $sink6
...
$nsim attach-agent $n(5) $udp7
$nsim attach-agent $n(49) $sink7
...
$nsim attach-agent $n(15) $udp8
$nsim attach-agent $n(11) $sink8
...
$nsim attach-agent $n(27) $udp9
$nsim attach-agent $n(16) $sink9
...
$nsim attach-agent $n(31) $udp10
$nsim attach-agent $n(45) $sink10
...
$nsim attach-agent $n(20) $udp13
$nsim attach-agent $n(30) $sink13
...
$nsim attach-agent $n(47) $udp14
$nsim attach-agent $n(38) $sink14
...
$nsim attach-agent $n(28) $udp15
$nsim attach-agent $n(24) $sink15
...
$nsim attach-agent $n(26) $udp16
$nsim attach-agent $n(8) $sink16
...
$nsim attach-agent $n(25) $udp17
$nsim attach-agent $n(33) $sink17
...
$nsim attach-agent $n(2) $udp18
$nsim attach-agent $n(14) $sink18
...
$nsim attach-agent $n(39) $udp19
$nsim attach-agent $n(36) $sink19
...
$nsim attach-agent $n(42) $udp21
$nsim attach-agent $n(40) $sink21
...
$nsim attach-agent $n(3) $udp22
$nsim attach-agent $n(48) $sink22
...
$nsim attach-agent $n(35) $udp24
$nsim attach-agent $n(19) $sink24
